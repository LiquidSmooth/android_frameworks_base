...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
       ...
       // PIE COLORS EVERYWHERE! //
         ...
         * @hide
         */
        public static final String PA_PIE_LAST_APP = "pie_last_app";

        /**
         * Pie kill task, default to 0 (off)
         * @hide
         */
        public static final String PA_PIE_KILL_TASK = "pie_kill_task";

        /**
         * Pie toggles omni torch
         * @hide
         */
        public static final String PA_PIE_TORCH = "pie_torch";

        /**
         * Pie action notifications, default to off
         * @hide
         */
        public static final String PA_PIE_ACT_NOTIF = "pie_act_notif";

        /**
         * Pie power, should default to 0 (no, show only when needed)
         * @hide
         */
        public static final String PA_PIE_POWER = "pie_power";
