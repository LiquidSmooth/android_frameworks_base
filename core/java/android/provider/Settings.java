...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
       ...
       /**
         ...
         * @hide
         */
        public static final String PA_PIE_CONTROLS = "pie_controls";

        /**
         * PA Pie menu, should default to 1 (yes, show)
         * @hide
         */
        public static final String PA_PIE_MENU = "pie_menu";

        /**
         * Pie will not rotate. Should default to 1, (yes, do not rotate)
         * @hide
         */
        public static final String PA_PIE_STICK = "pie_stick";

        /**
         * Center Pie? Should default to 1 (yes, center)
         * @hide
         */
        public static final String PA_PIE_CENTER = "pie_center";

        /**
         * Pie search, should default to 1 (yes, show)
         * @hide
         */
        public static final String PA_PIE_SEARCH = "pie_search";

        /**
         * Pie gap angle, should default to 2
         * @hide
         */
        public static final String PA_PIE_GAP = "pie_gap";

        /**
         * Pie empty angle, should default to 12
         * @hide
         */
        public static final String PA_PIE_ANGLE = "pie_angle";

        /**
         * Pie trigger fraction, should default to 1
         * @hide
         */
        public static final String PA_PIE_TRIGGER = "pie_trigger";
         ...
         * @hide
         */
        public static final String PA_PIE_GRAVITY = "pie_gravity";
         ...
         * @hide
         */
        public static final String PA_PIE_MODE = "pie_mode";

        /**
         * Pie size fraction, default is 1.0f (normal)
         * @hide
         */
        public static final String PA_PIE_SIZE = "pie_size";

        /**
         * Pie Notification Ability
         * @hide
         */
        public static final String PA_PIE_NOTIFICATIONS = "pie_notifications";
       ...
       // PIE COLORS EVERYWHERE! //
         ...
         * @hide
         */
        public static final String PA_PIE_ENABLE_COLOR = "pie_enable_color";

        /**
         * @hide
         */
        public static final String PA_PIE_JUICE = "pie_juice";

        /**
         * @hide
         */
        public static final String PA_PIE_BUTTON_COLOR = "pie_button_color";

        /**
         * @hide
         */
        public static final String PA_PIE_SNAP_BACKGROUND = "pie_snap_background";

        /**
         * @hide
         */
        public static final String PA_PIE_BACKGROUND = "pie_background";

        /**
         * @hide
         */
        public static final String PA_PIE_SELECT = "pie_select";

        /**
         * @hide
         */
        public static final String PA_PIE_OUTLINES = "pie_outlines";

        /**
         * @hide
         */
        public static final String PA_PIE_STATUS_CLOCK = "pie_status_clock";

        /**
         * @hide
         */
        public static final String PA_PIE_STATUS = "pie_status";

        /**
         * @hide
         */
        public static final String PA_PIE_CHEVRON_LEFT = "pie_chevron_left";

        /**
         * @hide
         */
        public static final String PA_PIE_CHEVRON_RIGHT = "pie_chevron_right";
